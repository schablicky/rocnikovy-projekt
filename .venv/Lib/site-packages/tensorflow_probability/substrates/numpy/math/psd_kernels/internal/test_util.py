...
from tensorflow_probability.substrates.numpy.math.psd_kernels import positive_semidefinite_kernel
...
#   `tensorflow_probability/substrates/numpy/math/psd_kernels/internal/test_util.py`
