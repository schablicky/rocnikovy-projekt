...
from tensorflow_probability.substrates.numpy.optimizer.convergence_criteria import convergence_criterion
...
#   `tensorflow_probability/substrates/numpy/optimizer/convergence_criteria/successive_gradients_are_uncorrelated.py`
