...
from tensorflow_probability.substrates.numpy.math import interpolation
...
#   `tensorflow_probability/substrates/numpy/experimental/linalg/linear_operator_interpolated_psd_kernel.py`
