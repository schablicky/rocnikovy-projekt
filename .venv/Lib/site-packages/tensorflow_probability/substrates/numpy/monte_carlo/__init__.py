...
from tensorflow_probability.substrates.numpy.monte_carlo.expectation import expectation
...
#   `tensorflow_probability/substrates/numpy/monte_carlo/__init__.py`
